...
// Copyright (c) 2013-2014 Killercoin Developers
...
uint256 hashGenesisBlock("0xe9c9dd450dd2bdd70edae219786b1496eeaa6d7fa2e79a33f060b5fa68bb844d");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Killercoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Killercoin Signed Message:\n";
...
{
    // Killercoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if (nHeight == 3) //bonus block reward nHeight, yes this is probably called premine, get over it!!. Devs need to pay for Exchanges, promos, faucets etc...
    {
        int64 nSubsidy = 5000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight >= 4 && nHeight <= 1399) // 5000 coins reward per block as there is likely to be many rejects at this nHeight
    {
        int64 nSubsidy = 5000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 1400) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight >= 1401 && nHeight <= 1999) // 5000 coins reward per block as there is likely to be many rejects at this nHeight
    {
        int64 nSubsidy = 5000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight >= 2000 && nHeight <= 4500) // 2000 coins reward per block as there is likely to be some rejects at this nHeight
    {
    ...
    else if (nHeight == 5067) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 13664) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 25554) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 34426) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 45763) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 56854) //bonus block reward nHeigh
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 68754) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 77777) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 77786) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 82341) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 88655) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 97632) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 98654) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 99999) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 110011) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 120045) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 133333) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 144445) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 151515) //bonus block reward nHeight
    {
        int64 nSubsidy = 1 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 161111) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 188888) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 210001) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else if (nHeight == 210010) //bonus block reward nHeight
    {
        int64 nSubsidy = 1000000 * COIN;
        return nSubsidy + nFees;
    }
    else
    {
        ...
        nSubsidy >>= (nHeight / 262800); // reward halves roughly every 1 year
        return nSubsidy + nFees;
    }
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Killercoin: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    /// debug print
    printf("GetNextWorkRequired *Standard* RETARGET\n");
...
unsigned int static KimotoGravityWell(const CBlockIndex* pindexLast, const CBlockHeader *pblock, uint64 TargetBlocksSpacingSeconds, uint64 PastBlocksMin, uint64 PastBlocksMax) {
    ...
    /// debug print
    printf("You've been retargeted using KGW!\n");
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Killercoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Killercoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x802788ce81ed7e7762cf483ca0558dc2da35710485b08d8dbc5af9e1b47a85bf"); //testnet hashGenesisBlock
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Russia steps up pressure towards Crimea.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799  << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        //        txNew.vin[0].scriptSig = CScript() << 0x43cdd819  << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        block.nVersion = 1;
        block.nTime    = 1393970270;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 880342;

        if (fTestNet)
        {
            block.nTime    = 1393967789;
            block.nNonce   = 532786;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5197db5f655f9cc4a4cc1782441b72f6e002e70e6364a51d2e8a480e8c1c83f2"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Killercoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KillercoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KillercoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static KillercoinMiner(CWallet *pwallet)
{
    printf("KillercoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("killercoin-miner");
    ...
    try { loop {
        ...
        printf("Running KillercoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("KillercoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&KillercoinMiner, pwallet));
}
