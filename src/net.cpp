...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Killercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"killercoin.eu", "dnsseed.killercoin.eu"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"killercoin.eu", "testnet-dnsseed.killercoin.eu"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Killercoin is probably already running."), addrBind.ToString().c_str());
        else
